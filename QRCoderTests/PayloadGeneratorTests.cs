...
namespace QRCoderTests
{
    ...
    public class PayloadGeneratorTests
    {
        ...
        public void bezahlcode_generator_can_generate_payload_singlepayment_minimal()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singlepayment?name=Wikimedia%20F%C3%B6rdergesellschaft&account=001194700&bnc=100205000&amount=10,00&currency=EUR&executiondate=27042017");
        }
        ...
        public void bezahlcode_generator_can_generate_payload_singlepayment_full()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singlepayment?name=Wikimedia%20F%C3%B6rdergesellschaft&account=001194700&bnc=100205000&postingkey=69&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=27042017");
        }
        ...
        public void bezahlcode_generator_can_generate_payload_singledirectdebit()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singledirectdebit?name=Wikimedia%20F%C3%B6rdergesellschaft&account=001194700&bnc=100205000&postingkey=69&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=27042017");
        }
        ...
        public void bezahlcode_generator_can_generate_payload_periodicsinglepayment()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://periodicsinglepayment?name=Wikimedia%20F%C3%B6rdergesellschaft&account=001194700&bnc=100205000&postingkey=69&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=27042017&periodictimeunit=W&periodictimeunitrotation=2&periodicfirstexecutiondate=27042017&periodiclastexecutiondate=27072017");
        }
        ...
        public void bezahlcode_generator_can_generate_payload_singlepaymentsepa_minimal()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singlepaymentsepa?name=Wikimedia%20F%C3%B6rdergesellschaft&iban=DE33100205000001194700&bic=BFSWDE33BER&amount=10,00&currency=EUR&executiondate=27042017");
        }
        ...
        public void bezahlcode_generator_can_generate_payload_singlepaymentsepa_full()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singlepaymentsepa?name=Wikimedia%20F%C3%B6rdergesellschaft&iban=DE33100205000001194700&bic=BFSWDE33BER&separeference=Fake%20SEPA%20reference&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=27042017");
        }
        ...
        public void bezahlcode_generator_can_generate_payload_singledirectdebitsepa()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singledirectdebitsepa?name=Wikimedia%20F%C3%B6rdergesellschaft&iban=DE33100205000001194700&bic=BFSWDE33BER&separeference=Fake%20SEPA%20reference&creditorid=DE%2002%20TSV%2001234567890&mandateid=987543CB2&dateofsignature=01032017&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=27042017");
        }
        ...
        public void bezahlcode_generator_can_generate_payload_periodicsinglepaymentsepa()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://periodicsinglepaymentsepa?name=Wikimedia%20F%C3%B6rdergesellschaft&iban=DE33100205000001194700&bic=BFSWDE33BER&separeference=Fake%20SEPA%20reference&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=27042017&periodictimeunit=M&periodictimeunitrotation=1&periodicfirstexecutiondate=27042017&periodiclastexecutiondate=27072017");
        }
        ...
        public void bezahlcode_generator_should_handle_account_whitespaces()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singlepayment?name=Wikimedia%20F%C3%B6rdergesellschaft&account=01194700&bnc=100205000&amount=10,00&currency=EUR&executiondate=27042017");
        }
